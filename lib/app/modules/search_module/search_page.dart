              ...
              Positioned(
                ...
                child: SafeArea(
                  child: CupertinoButton(
                    onPressed: controller.onPreviousStepPressed,
  ...
  Widget _footerWidget() {
    return Obx(
      () => Visibility(
        ...
        child: Opacity(
          opacity: controller.height / controller.maxHeight,
          // curve: Curves.easeOut,
          // duration: Duration(
          //     milliseconds: controller.solidController.smoothness!.value),
          child: Container(
    ...
    return Obx(
      () => Opacity(
        ...
        child: AnimatedContainer(
          ...
          height: controller.height() + Get.mediaQuery.padding.bottom + 46.w,
          width: 1.sw,
